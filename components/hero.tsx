        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 text-sm text-muted-foreground">
            <div className="flex items-center gap-1">
              ...
              <a href="mailto:manu.panjoria666@gmail.com">
                manu.panjoria666@gmail.com
              </a>
            </div>
            <div className="flex items-center gap-1">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            ...
            <Link href="https://github.com/manu6677" target="_blank">
              <Button
                variant="outline"
                size="sm"
            ...
            <Link href="mailto:manu.panjoria666@gmail.com" target="_blank">
              <Button
                variant="outline"
                size="sm"
                className="text-xs sm:text-sm"
            ...
            <Link href="https://x.com/maani1215" target="_blank">
              <Button
                variant="outline"
                size="sm"
                className="text-xs sm:text-sm"
            ...
            <Link
              href="https://www.linkedin.com/in/manupanjoria773/"
              target="_blank"
            >
              <Button
                variant="outline"
