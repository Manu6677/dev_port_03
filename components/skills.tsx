...
const skillCategories = [
  {
    ...
    skills: [
      ...
      {
        name: "Angular",
        icon: <IoLogoAngular className="text-red-500" />,
      },
  ...
  },
  {
    ...
    skills: [
      {
        name: "React query",
        icon: <SiReactquery className="text-pink-900" />,
      },
      { name: "NodeJs", icon: <IoLogoNodejs className="text-green-600" /> },
      { name: "Express", icon: <SiExpress className="text-gray-100" /> },
      { name: "Django", icon: <BiLogoDjango className="text-green-300" /> },
...

  {
    ...
    skills: [
      {
        name: "Supabase",
        icon: <TbBrandSupabase className="text-green-700" />,
      },
